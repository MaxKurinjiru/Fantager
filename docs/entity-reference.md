...
| Enum                | Values                                                                                                                                                                                                                                            |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Race`              | human, elf, dwarf, orc, undead, giant, ent, genie. Ent and Giant use a 7-hex combat footprint (see [combat-system.md](systems/combat-system.md#unit-footprint-size)). |
